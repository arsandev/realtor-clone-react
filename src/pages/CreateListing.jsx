      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex">
          <button
            ...
            value="sale"
            onClick={onChange}
            className={`mr-3 px-7 py-3 font-medium tex-sm uppercase shadow-md rounded
          ...
          <button
            ...
            value="rent"
            onClick={onChange}
            className={`ml-3 px-7 py-3 font-medium tex-sm uppercase shadow-md rounded
                hover:shadow-lg focus:shadow-lg active:shadow-lg
                transition duration-150 ease-in-out w-full ${
                  type === "sale"
                    ? "bg-white text-black"
